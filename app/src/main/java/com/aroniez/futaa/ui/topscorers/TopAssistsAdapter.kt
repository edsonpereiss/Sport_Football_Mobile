...
import com.aroniez.futaa.models.seasons.topscorers.AssistScorer
...
class TopAssistsAdapter(private val teams: ArrayList<AssistScorer>, private val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
